...
% So make sure you use this to make your edge order!
nodePot = reshape(nodePot,[nr*nc nstates]);
[V,E] = StarEdge_MakeEdgeNums_Lattice2(nr,nc);

fprintf('this is infer working...');

% =================Now try it with the C code:
...
[nodeBel,niter,edgeBel,F]=MF_GeneralComplex_C(...
    edgePot,nodePot,infEng.maxIter,infEng.tol,int32(V),int32(E));
logZ = -F;
